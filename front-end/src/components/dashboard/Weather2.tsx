...
const Weather2 = () => {
  ...
  const getPtyInfo = (value) => {
    ...
    if (value === "0") {
      ...
      pty = "비/눈";
      pty_icon =
        "https://bmcdn.nl/assets/weather-icons/v3.0/fill/svg/sleet.svg";
    } else if (value === "3") {
      pty = "눈";
    ...
    <div className="weather-container">
        ...
        <div className="today-info">
          {hasValue && !loading ? (
            <section>
              <img
                src={
                  !todayWeather.icon2 ? todayWeather.icon : todayWeather.icon2
                }
      ...
      <div className="status-container">
        <div className="status-box">
          ...
          <span>
            {weather.main ? weather.main.pressure + "hpa" : 0 + "hpa"}
          </span>
          <p>pressure</p>
        </div>
        <div className="status-box">
