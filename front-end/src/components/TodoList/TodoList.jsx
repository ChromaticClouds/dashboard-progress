...
const TodoList = () => {
  ...
  const { date, visible, setVisible, setStatus, status, currentDate } =
    useCalendarEvents();
  ...
  const week = (date) => {
    // getDay() 메서드로 받아온 week 스테이트 키값을 스트링 포맷
    let getDay = "";
    ...
    <div>
      ...
      >
        <div className="sort">
          <div className="bar">
            <p>
              ToDoList - {week(date.week)}, {date.month}/{date.day}/{date.year}
            </p>
            <FontAwesomeIcon
                      ...
                      <div className="todo-box" key={todo._id}>
                        ...
                        <div className="text-sort">
                          ...
                          <div className="contents">
                            ...
                            <span>
                              {todo.todo === "" ? todo.message : todo.todo}
                            </span>
                          </div>
                        </div>
                        <input
                ...
                <div className="date-list">
                  <div>
                    <div
                      ...
                      className={startToggle ? "active" : "active inactive"}
                    >
                      {startDate[0]}
                    </div>
                    <input
                  ...
                  <div>
                    <div
                      ...
                      className={endToggle ? "active" : "active inactive"}
                    >
                      {endDate[0]}
                    </div>
                    <input
                  ...
                  >
                    ...
                    <div>
                      <FontAwesomeIcon
                        ...
                        onClick={(e) => {
                          setSelectedIndex(null), e.stopPropagation();
                        }}
                      />
                    </div>
                    <FontAwesomeIcon
