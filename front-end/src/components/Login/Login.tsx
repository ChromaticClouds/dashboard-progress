...
const Login = () => {
  ...
  const usernameRegex = (username) => {
    ...
    const startsWithUnderline = VerEx().startOfLine().then("_").test(username);
    ...
    const endsWithUnderline = VerEx().endOfLine().then("_").test(username);
  ...
  useEffect(() => {
    ...
    if (validInputUser.valid) {
      ...
      const checkDuplicateUsername = async () => {
        const duplicateUsername = await duplicateUsernameVerify(
          register.username
        );
  ...
  useEffect(() => {
    const validateForm = async () => {
      ...
      const emailValid =
        emailRegex(register.email).valid || register.email === "";
      ...
      setIsFormValid(
        usernameValid && passwordValid && emailValid && !isUsernameDuplicate
      );
    };
        ...
        <section className="forms-container">
          <div className="signin-signup">
            ...
            <form className="sign-in-form" onSubmit={submitLoginForm}>
              ...
              {loginError && (
                <span className="error-message red">{loginError.message}</span>
              )}
              {loading ? (
            ...
            <form className="sign-up-form" onSubmit={submitRegisterForm}>
              ...
              <span className={`error-message ${usernameResult.color}`}>
              ...
              <input
                ...
                className={`sign-in-btn ${
                  !isFormValid ? "unvalid-register" : "register"
                }`}
        ...
        <section className="panels-container">
          <div className="panel left-panel">
            <div className="content">
              <h3>New here?</h3>
              <p>
                Create an account to create and check out your own small plant
                growth projects.
              </p>
              <button
                className="sign-in-btn transparent"
          ...
          <div className="panel right-panel">
            <div className="content">
              ...
              <p>
                ...
                account and continue make your project run.
              </p>
              <button
                className="sign-in-btn transparent"
