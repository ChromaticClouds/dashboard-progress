          ...
          if (category === "SKY" && fc_date === today && fc_time === th_hour) {
            switch (value) {
              case 1:
                today_sky = "맑음";
                today_sky_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/clear-day.svg";
                break;
              case 2:
                today_sky = "구름 조금";
                today_sky_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/partly-cloudy-day.svg";
                break;
              case 3:
                today_sky = "구름 많음";
                today_sky_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/cloudy.svg";
                break;
              case 4:
                today_sky = "흐림";
                today_sky_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/overcast.svg";
                break;
            }
          }
          ...
          if (category === "PTY" && fc_date === today && fc_time === th_hour) {
            switch (value) {
              case 1:
                today_pty = "비";
                today_pty_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/drizzle.svg";
                break;
              case 2:
                today_pty = "비/눈";
                today_pty_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/sleet.svg";
                break;
              case 3:
                today_pty = "눈";
                today_pty_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/snow.svg";
                break;
              case 4:
                today_pty = "소나기";
                today_pty_icon =
                  "https://bmcdn.nl/assets/weather-icons/v2.0/fill/rain.svg";
                break;
            }
          }
  ...
  return (
    <div className="weather-container">
      ...
      <div className="today-info">
        <img
          src={오늘날씨.pty == null ? 오늘날씨.icon : 오늘날씨.icon2}
        ...
        <div className="temp-info">
          {오늘날씨.maxTemp}° / {오늘날씨.minTemp}°
        </div>
      </div>

      <div className="tomorrow-info">
        <img
          src={내일날씨.pty == null ? 내일날씨.icon : 내일날씨.icon2}
          className="weather-icon"
        />
        <div className="weather-info">
        ...
        <div className="temp-info2">
          {내일날씨.maxTemp}° / {내일날씨.minTemp}°
        </div>
      </div>
      ...
      <div className="status-container">
        <div className="status-box">
          ...
          <span>
            {weather.main ? weather.main.pressure + " mb" : 0 + " mb"}
          </span>
          <p>pressure</p>
        </div>
        <div className="status-box">
