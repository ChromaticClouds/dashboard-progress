        ...
        <div className="category">
          <div className="button-container">
            ...
            <div
              ...
              style={{
                marginLeft:
                  host === 1 ? "40px" : host === 2 ? "190px" : "340px",
              }}
            ></div>
          </div>
        </div>
        {username !== "null" && (
          <h4 className="subtitle">Hello, {username}!</h4>
        )}
        <div className="date">
          <FontAwesomeIcon
        ...
        <div className="monitoring-sort">
          ...
          <div className="harvest-box-sort">
            ...
            <div>
              {/* @todo: 생산가능성 표기 */}
              <span>{`${
                isEmpty || isNaN(hostValue.slice(-1)[0])
                  ? "0 %"
                  : `${hostValue.slice(-1)[0].toFixed(0)} %`
              }`}</span>
