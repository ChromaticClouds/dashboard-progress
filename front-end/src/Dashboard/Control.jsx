...
import BulletChart2 from "../components/chart/BulletChart2";
...
const Control = () => {
  ...
  const [value1, set_value1] = useState(
    localStorage.getItem("slider-data1") || 0
  );
  const [value2, set_value2] = useState(
    localStorage.getItem("slider-data2") || 0
  );
  const [value3, set_value3] = useState(
    localStorage.getItem("slider-data3") || 0
  );
  ...
  const [intensity, set_intenstiy] = useState(
    localStorage.getItem("intensity-data") || 0
  );
  const [duration, set_duration] = useState(
    localStorage.getItem("duration-data") || 0
  );
          ...
          <div>
            ...
            <div className="range">
              <div className="slider-value">
                <span
                  className={show_value1 ? "show" : ""}
                  style={slider_value_style1}
                >
                  {value1}
                </span>
              </div>
            ...
            <div className="range">
              <div className="slider-value">
                <span
                  className={show_value2 ? "show" : ""}
                  style={slider_value_style2}
                >
                  {value2}
                </span>
              </div>
            ...
            <div className="range">
              <div className="slider-value">
                <span
                  className={show_value3 ? "show" : ""}
                  style={slider_value_style3}
                >
                  {value3}
                </span>
              </div>
                ...
                <div className="box">
                  ...
                  <div className="field">
                    ...
                    <input
                      ...
                      disabled={!checked}
                    ></input>
                    <progress min="0" max="5" value={intensity}></progress>
                ...
                <div className="box">
                  ...
                  <div className="field">
                    ...
                    <input
                      ...
                      disabled={!checked}
                    ></input>
                    <progress min="0" max="5" value={duration}></progress>
                    <div className="bottom">-</div>
                  </div>
                </div>
                <div className="status">
                ...
                <div className="circle">
                  <div className="skill">
                    <div className="outer">
                      <div className="inner">
                        <div
                          className={push ? "pushed" : "number"}
                          onClick={checked ? pushed : null}
                        >
                ...
                <div className="status-container">
                  <div className="status-manage">
                    ...
                    <div className="text-box">
                      <p>soil humidity</p>
                      <span>
                        {sensor_data ? sensor_data.soil_humidity : 0} %
                      </span>
                    </div>
                  </div>
              ...
              <div className="sort">
                <div className="container">
                  ...
                  <div className="humid-bar bar-box">
                    <div className="status">
                      <p>humidity</p>
                      <div className="value">{humid} %</div>
                    </div>
                    <div className="chart">
                      <div className="length">
                        <BulletChart2 data={humidity} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="sort">
                  <div className="heater device">
                    <div className="disc">
                      ...
                      <span className="set-value">
                        {desired_heat().toFixed(0)} °C
                      </span>
                    </div>
                    <div
                      className={heater_operate ? "button-on" : "button-off"}
                    >
                      <button
                        className={
                          heater_operate
                    ...
                    <div className="temperature-graduation">
                      {heat_disc.map((grade, index) => (
                        <span
                          ...
                          style={{ transform: `${heat_element_style(grade)}` }}
                        >
                          <div className="point">
                    ...
                    <div className="lower-container">
                      <div
                        ...
                        style={{
                          transform: `translate3d(${slider_x}px, 0, 0)`,
                        }}
                      >
                        <svg
                          width="150"
                  ...
                  <div className="cooling-fan device">
                    <div className="disc">
                      <p>Cooling Fan</p>
                      <span className="set-value">
                        {desired_cool().toFixed(0)} °C
                      </span>
                    </div>
                    <div
                      className={cooler_operate ? "button-on" : "button-off"}
                    >
                      <button
                        className={
                          cooler_operate
                    ...
                    <div className="temperature-graduation">
                      {cool_disc.map((grade, index) => (
                        <span
                          key={index}
                          className="temperature-element"
                          style={{ transform: `${cool_element_style(grade)}` }}
                        >
                          <div className="point">
                            <span className="number">{grade}</span>
                            <span className="line">|</span>
                    ...
                    <div className="lower-container">
                      <div
                        className="slider-container"
                        style={{
                          transform: `translate3d(${slider_x2}px, 0, 0)`,
                        }}
                      >
                        <svg
                          width="150"
